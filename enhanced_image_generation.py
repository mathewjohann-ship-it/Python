...
def main():
    ...
    print("This program generates an image from text and applies post_processing effects.")
    print("Type 'exit' to quit.\n")

    while True:
        user_input = input("Enter a descriotion for the image (or 'exit' to quit):\n")
        ...
        try:
            ...
            print("Applying post_processing effects...\n")
