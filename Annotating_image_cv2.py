...
height_label_position = (arrow_start[0] - 500, (arrow_start[1] + arrow_end[1]//2))
cv2.putText(image_rgb, f"Height: {height} px", height_label_position, font, 2, (255, 255, 0), 2, cv2.LINE_AA)
